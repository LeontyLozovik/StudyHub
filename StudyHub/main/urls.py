...
urlpatterns = [
    ...
    path('course/change_status/<int:pk>', ChangeStatus.as_view(), name ='change_status'),
    path('change_password/', ChangePassword.as_view(), name='change_password'),
    path('search/', Search.as_view(), name='search'),
    path('favorites/', Favorites.as_view(), name='favorites'),
    path('favorietes/change_state/<int:pk>/', FavStatusChange.as_view(), name='fav_change'),
    path('course/<int:pk>/finish/', Feedback.as_view(), name='finish'),
    path('lesson/<int:pk>/create_note/', CreateNote.as_view(), name='create_note'),
    path('lesson/note/update/<int:pk>', UpdateNote.as_view(), name='update_note'),
    path('lesson/note/delete/<int:pk>', DeleteNote.as_view(), name='delete_note'),
    path('lesson/<int:pk>/add_to_course/', AddToCourse.as_view(), name='add_lesson_to_course'),
    path('course/<int:course_pk>/delete_lesson/<int:lesson_pk>', RemoveFromCourse.as_view(), name='remove_lesson_from_course'),
